...
import { EditCourierByCourierUseCase } from "./edit-courier-by-courier"

let inMemoryCouriersRepository: InMemoryCouriersRepository
let inMemoryAdminsRepository: InMemoryAdminsRepository
let sut: EditCourierByCourierUseCase

describe("Edit Courier by Courier", () => {
  beforeEach(() => {
    inMemoryCouriersRepository = new InMemoryCouriersRepository
    inMemoryAdminsRepository = new InMemoryAdminsRepository
    sut = new EditCourierByCourierUseCase(inMemoryCouriersRepository, inMemoryAdminsRepository)
  })
