...
type MarkShipmentAsPickedUpResponse = Either<NotAuthorizedError | ResourceNotFoundError, {
  shipment: Shipment
}>

export class MarkShipmentAsPickedUp {
  constructor(
  ...
  async execute({
    ...
    courierId,
    shipmentId
  }:MarkShipmentAsPickedUpRequest): Promise<MarkShipmentAsPickedUpResponse> {
